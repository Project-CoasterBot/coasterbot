...
2 & 21.07.2026 & Borutta, Such & Literaturrecherche und Einleitungstext ergänzt; Coasterbot-Abbildung eingefügt; Timeline und Projektzeitraum angepasst\\
3 & 22.07.2026 & Such & Versionshistorie ergänzt\\
\bottomrule
\end{tabularx}
...
\begin{wrapfigure}{r}{0.4\textwidth}
  \centering
  \includegraphics[width=0.38\textwidth]{coasterbot.png}
%  \caption{Coasterbot}
  \label{coasterbot}
\end{wrapfigure}

In diesem Projekt soll ein Prototyp eines Coasterbots entwickelt werden. Ein Coasterbot ist ein Handtellergroßer Roboter, welcher selbstständig auf einem Tisch navigiert und dort Getränkeuntersetzer in Richtung von Personen spendet und diese automatisiert wieder aufnimmt. Außerdem soll der Coasterbot in Ausbaustufen Flüssigkeit vom Tisch aufnehmen und diesen so reinigen können. Optional kann der Coasterbot Getränke befördern, Bestellungen aufnehmen und Bezahlvorgänge initialisieren. 

Durch diese Arbeiten setzt der Roboter Ressourcen beim Bedienpersonal in der Gastronomie frei, da sich ihr Aufgabenbereich reduziert. Außerdem ist ein solcher robotischer Helfer in der Gastronomie ein Alleinstellungsmerkmal für Bars und Restaurants und somit ein zusätzliches Attraktivitätsmerkmal für eine Gastronomie. Dieses Attraktivetätsmerkmal kann dazu führen, dass es mehr positive Bewertungen gibt und damit die online Präsenz eines lokals verbessert. Dies dürfte einen direkten Einfluss auf den Umsatz haben, da eine von YouGov durchgeführt Studie herausfand, dass die online Präsenz eine zunehmendere Relevanz bei der Restaurantauswahl besitzt. \cite{BibEntry2026Jul} Es wird außerdem erwartet, dass der Coasterbot in der Gatronomie einen Mehrwert bietet, da diese Branche seit mehreren Jahren unter einen Fachkräftemangel leidet und das Personal in der Gastronomie damit stark belastet ist. \cite{DEHOGA2025Q4} Weiterhin lassen Studien erkennen, dass Gäste elektronische Hilfsmittel in der Gastronomie zunehmend akzeptieren und diese als Mehrwert wahrnehmen, wenn sie eine Serviceleistung beschleunigen. \cite{PlonerOrderman2012, BibEntry2026Jan} Dies soll in einer ersten Ausbaustufe mit dem Coasterbot durch die Ausgabe und Aufnahme von Getränkedeckeln erreicht werden.


Im Rahmen dieser Prototyp Entwicklung soll die folgende \textit{Definition of Done} gelten:
\begin{itemize}
\item STL-Dateien und Schaltplänen zur Fertigung eines Prototypen sind fertiggestellt
...
Nicht im Rahmen dieser Entwicklung(\textit{Out of scope}) sind:
\begin{itemize}
...
Der zeitliche Rahmen ist hart begrenzt auf den Projektbeginn am \textbf{15.7.2026} sowie Projektabschluss am \textbf{7.11.2026}.
...
\begin{center}
\begin{tabular}{lll}
Dennis Burutta & Leiter & dennis.borutta@outlook.com\\
Stefan Etringer & Admin & mail@stefan.works \\
...
Im Projektplanungstool Notion wurde durch das Team bereits ein Zeitplan hinterlegt. Dieser sieht für alle Teammitglieder wie folgt aus, der Übersichtlichkeit halber hier in reduzierter Komplexität, siehe Abbildung \ref{notiontimeline}. 

\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.3]{notion_proj_uebersicht_schmal.png}
  \caption{Notion Timeline}
  \label{notiontimeline}
\end{figure}



Die Arbeitspakete gliedern sich in Mind-Map Darstellung wie in Abbildung \ref{arbeitspaketemindmap}, daraus ergibt sich der Projektstrukturplan mit Arbeitspaketen wie in Abbildung \ref{projektstrukturplan} gezeigt. 

\begin{figure}[htbp]
  \centering
  \includesvg[scale=0.4]{MindMap-Seite-1.drawio.svg}
  \caption{Mindmap zur Projektstruktur}
  \label{arbeitspaketemindmap}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includesvg[scale=0.45]{Projektstrukturplan-Seite-1.drawio.svg}
...
\makebox[\linewidth]{%
  \begin{minipage}{\dimexpr\paperheight-2.4cm\relax}
    \centering
    \includesvg[width=\linewidth]{Coasterbot_Netzplan_PSP.svg}
...
\section{Planung Entwicklungsphase}
