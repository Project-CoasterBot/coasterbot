...
\vspace{5em}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=0.5\textwidth]{coasterbot.png}
%      \caption{Coasterbot}
      \label{coasterbot}
    \end{figure}
...
Projektzeitraum & Beginn: \textbf{15.07.2026} \quad | \quad Abschluss: \textbf{07.11.2026} (hart begrenzt) \\
\midrule

Kurzbeschreibung & Entwicklung eines Prototyps eines Coasterbots: ein handtellergro{\ss}er Roboter, der selbstst\"andig auf einem Tisch navigiert, dort Getr\"ankeuntersetzer in Richtung von Personen ausgibt und diese automatisiert wieder aufnimmt. \\
\midrule

Ausbaustufen & Automatisierte Tischreinigung, Aufnahme von Bestellungen, Initialisierung von Bezahlvorg\"angen \\
\midrule
...
Umsetzung 1. Ausbaustufe & Ausgabe und Aufnahme von Getr\"ankeuntersetzern (Deckeln) \\
\midrule
