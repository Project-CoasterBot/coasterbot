...
4 & 19.08.2026 & Such & Mindmap für Komponenten\\
\bottomrule
\end{tabularx}
...
\clearpage
\section{Übersicht aller Möglichkeiten}

\vspace*{\fill}
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{%
    \includegraphics[width=1.2\textwidth]{Coasterbot_Komponenten_Mglkeiten.pdf}%
  }
  \caption{Übersicht der betrachteten Komponenten und Lösungsvarianten}
  \label{fig:komponenten-moeglichkeiten}
\end{figure}
\vspace*{\fill}
\clearpage
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{%
    \includegraphics[width=1.2\textwidth]{Coasterbot_Komponenten_Auswahl.pdf}%
  }
  \caption{Übersicht der ausgewählten Komponenten und Lösungsmöglichkeiten}
  \label{fig:komponenten-auswahl}
\end{figure}
\vspace*{\fill}
%\clearpage
