...
\midrule
1 & 19.08.2026 & Etringer & Erstfassung der Alternativenbeschreibung\\
2 & 23.08.2026 & Etringer & Formatierung und Kapitelstruktur\\
\bottomrule
\end{tabularx}
...
\subsection{Vollständige Testfallmatrix (Anforderung → Test-ID →
Ergebnis)}\label{vollstuxe4ndige-testfallmatrix-anforderung-test-id-ergebnis}
...
\subsubsection{Übersicht der
Test-ID-Struktur}\label{uxfcbersicht-der-test-id-struktur}
...
\subsubsection{Komponententests}\label{komponententests-2}
...
\bottomrule\noalign{}
\endlastfoot
CT-HW-001 & Verarbeitung von Sensordaten & Hardware-abstraktion &
...
geplant \\
CT-MOT-001 & Umsetzung von Bewegungsbefehlen & Bewegungs-steuerung &
NAV-009, SAF-004 & P1 & geplant \\
CT-CST-001 & Aufnahme eines Getränkeuntersetzers & Untersetzer-handling
& CST-001, CST-005 & P2 & geplant \\
CT-CST-002 & Fehler bei Untersetzeraufnahme & Untersetzer-handling &
CST-005, MON-005 & P2 & geplant \\
CT-SAF-001 & Sicherheitsstopp & Sicherheits-komponente & SAF-001,
SAF-006 & P1 & geplant \\
CT-MON-001 & Fehlererkennung und Protokollierung & System-überwachung &
MON-001, MON-002 & P1 & geplant \\
\end{longtable}

\subsubsection{Integrationstests}\label{integrationstests-2}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0526}}
...
geplant \\
IT-MON-001 & Fehlerweitergabe im Gesamtsystem & Sensorik,
Monitoring,Sicherheit & MON-001, MON-002, MON-005 & P1 & geplant \\
IT-HW-SIM-001 & Austausch Hardware durch Simulation &
Hardwareabstraktion, Simulation & NFR-003, NFR-004, NFR-007 & P2 &
geplant \\
\end{longtable}

\subsubsection{Simulationstests}\label{simulationstests-2}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3134}}
...
ST-SIM-005 & Reaktion auf fehlerhafte Sensordaten & Fehler-behandlung &
...
\subsubsection{Systemtests}\label{systemtests-2}
...
SYS-005 & Aufnahme eines Getränkeuntersetzers & Untersetzer-handling &
CST-001, CST-005 & P2 & geplant \\
SYS-006 & Platzierung eines Untersetzers & Untersetzer-handling &
...
MON-005 & P1 & geplant \\
SYS-009 & Überwachung des Akkuzustands & Energie-versorgung & EN-001,
...
\subsubsection{Testabdeckung nach
Anforderungsbereich}\label{testabdeckung-nach-anforderungsbereich}
...
\subsubsection{Testpriorisierung}\label{testpriorisierung}

\paragraph{Priorität P1 -- Kritische
...
\paragraph{Priorität P3 -- Optionale
...
\subsubsection{Teststatusdefinition}\label{teststatusdefinition}
...
\subsection{Testprotokoll-Vorlagen}\label{testprotokoll-vorlagen}

\subsubsection{Zweck des Testprotokolls}\label{zweck-des-testprotokolls}
...
Testinformationen}\label{allgemeine-testinformationen}

\subsubsection{Testprotokoll}\label{testprotokoll}
...
Testziels}\label{beschreibung-des-testziels}

\paragraph{Ziel des Tests}\label{ziel-des-tests}

\textbf{Beschreibung:}

\subsubsection{Zugeordnete
...
\subsubsection{Testvoraussetzungen}\label{testvoraussetzungen}
...
\subsubsection{Testaufbau}\label{testaufbau-9}
...
\paragraph{Verwendete Komponenten}\label{verwendete-komponenten}
...
\paragraph{Testdurchführung}\label{testdurchfuxfchrung}

\paragraph{Ablauf}\label{ablauf-34}
...
\paragraph{Erwartetes Ergebnis}\label{erwartetes-ergebnis-34}

Beschreibung des erwarteten Systemverhaltens:

\paragraph{Tatsächliches Ergebnis}\label{tatsuxe4chliches-ergebnis}

Beschreibung des beobachteten Verhaltens:

\paragraph{Bewertung des
Testergebnisses}\label{bewertung-des-testergebnisses}

\paragraph{Testergebnis}\label{testergebnis}
...
\paragraph{Begründung}\label{begruxfcndung}

\subsubsection{Fehlerdokumentation}\label{fehlerdokumentation}
...
\paragraph{Fehlerbeschreibung}\label{fehlerbeschreibung}

\paragraph{Fehleranalyse}\label{fehleranalyse-1}

\paragraph{Ursache}\label{ursache}

\paragraph{Auswirkungen}\label{auswirkungen}

\paragraph{Maßnahmen}\label{mauxdfnahmen}

\paragraph{Testabschluss}\label{testabschluss-1}

\subsubsection{Zusammenfassung}\label{zusammenfassung-4}

Kurze Bewertung des Testverlaufs:

\paragraph{Testergebnis bestätigt
...
\subsubsection{Vorlage für automatisierte
Tests}\label{vorlage-fuxfcr-automatisierte-tests}
...
\paragraph{Beispiel eines automatisierten
...
\subsubsection{Vorlage für
Simulationstests}\label{vorlage-fuxfcr-simulationstests}
...
\paragraph{Simulationsszenario}\label{simulationsszenario}

Beschreibung

\subparagraph{Startbedingungen}\label{startbedingungen}
...
\subparagraph{Ergebnisvergleich}\label{ergebnisvergleich}
...
\subparagraph{Vorlage für Systemtests}\label{vorlage-fuxfcr-systemtests}
...
\subsubsection{Zusammenfassung}\label{zusammenfassung-5}
...
\subsection{Traceability-Matrix Lastenheft → Pflichtenheft →
Testfälle}\label{traceability-matrix-lastenheft-pflichtenheft-testfuxe4lle}

\subsubsection{Zweck der
Traceability-Matrix}\label{zweck-der-traceability-matrix}
...
\subsubsection{Navigation und
Lokalisierung}\label{navigation-und-lokalisierung-1}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0488}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2927}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3049}}
...
ST-SIM-002, SYS-003 & Kompo-nenten, Integration, Simulation, System &
geprüft \\
...
Kompo-nenten, Integration, Simulation & geprüft \\
...
mit Routenneuberechnung & CT-NAV-001, ST-SIM-002 & Kompo-nenten,
Simulation & geprüft \\
NAV-006 & Der Bot muss Position bestimmen können &
Lokalisierungs-komponente verarbeitet Positionsdaten & CT-LOC-001,
IT-LOC-NAV-001 & Kompo-nenten, Integration & geprüft \\
...
Getränkeuntersetzer}\label{anforderungen-getruxe4nkeuntersetzer}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0864}}
...
SYS-005 & Kompo-nenten, Simulation, System & geprüft \\
...
Aufnahmeprozess mit Zustandserkennung & CT-CST-001 & Kompo-nenten &
geprüft \\
CST-005 & Der Bot muss erfolgreiche Aufnahme erkennen & Sensorbasierte
Zustandsprüfung & CT-CST-001, CT-CST-002 & Kompo-nenten & geprüft \\
CST-006 & Der Bot muss erfolgreiche Platzierung erkennen & Statusprüfung
nach Ablagevorgang & SYS-006 & System & geprüft \\
\end{longtable}

\subsubsection{Sicherheitsanforderungen}\label{sicherheitsanforderungen}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0494}}
...
SYS-007 & Kompo-nenten, Integration, System & geprüft \\
...
Komp-onenten, Integration & geprüft \\
...
Sicherheitslogik & CT-SAF-001, SYS-007 & Kompo-nenten, System &
geprüft \\
\end{longtable}

\subsubsection{Systemüberwachung}\label{systemuxfcberwachung-1}
...
& CT-MON-001, IT-MON-001, SYS-008 & Kompo-nenten, Integration, System &
geprüft \\
MON-002 & Fehler protokollieren & Fehlerlogging innerhalb der
Systemüberwachung & CT-MON-001, IT-MON-001 & Kompo-nenten, Integration &
geprüft \\
...
& CT-CST-002, SYS-008 & Kompo-nenten, System & geprüft \\
\end{longtable}

\subsubsection{Nichtfunktionale
...
der Softwaremodule & CT-HW-001 bis CT-MON-001 & Kompo-nenten &
geprüft \\
...
& CT-Tests & Kompo-nenten & geprüft \\
NFR-006 & Kernfunktionen müssen automatisiert testbar sein &
Testframework und automatisierte Testfälle & CT-Tests & Kompo-nenten &
geprüft \\
NFR-007 & Sensoren und Aktoren müssen austauschbar sein &
Hardwareabstraktions-schicht & CT-HW-001, IT-HW-SIM-001 & Kompo-nenten,
Integration & geprüft \\
NFR-008 & Hardwareabstraktion unterstützen & Abstrakte Schnittstellen
zwischen Hard- und Software & CT-HW-001 & Kompo-nenten & geprüft \\
\end{longtable}

\subsubsection{Simulationsanforderungen}\label{simulationsanforderungen}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0988}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2469}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3086}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1111}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1358}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0988}}@{}}
...
\subsubsection{Anforderungen außerhalb des
Projektumfangs}\label{anforderungen-auuxdferhalb-des-projektumfangs}
...
\subsubsection{Zusammenfassung}\label{zusammenfassung-6}
...
\subsection{Risikoanalyse und
Testpriorisierung}\label{risikoanalyse-und-testpriorisierung}

\subsubsection{Zweck der Risikoanalyse}\label{zweck-der-risikoanalyse}
...
\subsubsection{Bewertungsmethode}\label{bewertungsmethode}

Die Risikobewertung erfolgt anhand einer qualitativen Bewertungsskala.

\subsubsection{Eintrittswahrscheinlichkeit}\label{eintrittswahrscheinlichkeit}
...
\subsubsection{Auswirkung}\label{auswirkung}
...
\subsubsection{Risikopriorität}\label{risikopriorituxe4t}
...
\subsubsection{Technische Risikoanalyse}\label{technische-risikoanalyse}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0769}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2747}}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0549}}
...
\subsubsection{Sicherheitsrisiken}\label{sicherheitsrisiken}

\paragraph{Verlust der
Tischsicherheit}\label{verlust-der-tischsicherheit}

\subparagraph{Beschreibung}\label{beschreibung-1}
...
\subparagraph{Auswirkungen}\label{auswirkungen-1}
...
\subparagraph{Gegenmaßnahmen}\label{gegenmauxdfnahmen}
...
\subparagraph{Zugeordnete Tests}\label{zugeordnete-tests}
...
\paragraph{Kollision mit Objekten oder
Personen}\label{kollision-mit-objekten-oder-personen}

\subparagraph{Beschreibung}\label{beschreibung-2}

Der Coasterbot bewegt sich in einer Umgebung mit wechselnden
Hindernissen und potenziellen Kontaktpunkten.

\subparagraph{Auswirkungen}\label{auswirkungen-2}
...
\subparagraph{Gegenmaßnahmen}\label{gegenmauxdfnahmen-1}
...
\subparagraph{Zugeordnete Tests}\label{zugeordnete-tests-1}
...
\subsubsection{Softwarerisiken}\label{softwarerisiken}

\paragraph{Fehlerhafte
Systemzustände}\label{fehlerhafte-systemzustuxe4nde}

\subparagraph{Beschreibung}\label{beschreibung-3}
...
\subparagraph{Auswirkungen}\label{auswirkungen-3}
...
\subparagraph{Gegenmaßnahmen}\label{gegenmauxdfnahmen-2}
...
\subparagraph{Zugeordnete Tests}\label{zugeordnete-tests-2}
...
\paragraph{Fehlende
Hardwareabstraktion}\label{fehlende-hardwareabstraktion}

\subparagraph{Beschreibung}\label{beschreibung-4}

Eine unzureichende Trennung zwischen Hard- und Software kann spätere
Erweiterungen erschweren.

\subparagraph{Auswirkungen}\label{auswirkungen-4}
...
\subparagraph{Gegenmaßnahmen}\label{gegenmauxdfnahmen-3}
...
\subparagraph{Zugeordnete Tests}\label{zugeordnete-tests-3}
...
\subsubsection{Projektrisiken}\label{projektrisiken}
...
Planung \\
PR-002 & Umfangsüber-schreitung & Erweiterung um nicht geplante
...
\subsubsection{Testpriorisierung}\label{testpriorisierung-1}
...
\paragraph{Prioritätsstufen der
Tests}\label{priorituxe4tsstufen-der-tests}

\subparagraph{Priorität P1 -- Kritische
...
\subsubsection{Maßnahmen zur
Risikoreduzierung}\label{mauxdfnahmen-zur-risikoreduzierung}
...
\paragraph{Sicherheit}\label{sicherheit}
...
\subsubsection{Zusammenfassung}\label{zusammenfassung-7}
