...
7 & 14.09.2026 & Etringer & Ausblick \enquote{initiale Tischerkundung} zu einem konkreten Stufenplan (0--7) ausgearbeitet\\
\bottomrule
\end{tabularx}
...
entfällt dieser Mittelungsschritt -- sie liest ohnehin nur einen Encoder
je Seite.
...
Abschnitt~\ref{webotshal}) -- kein analoger Schwellenwert mehr im Code.
...
Untersetzer), ohne Kollisionskörper -- das Objekt wird per Supervisor
platziert, nicht angefahren.
...
besitzt, aber bislang ungenutzt lässt (Abschnitt~\ref{proto}).
...
innen versetzt, jeweils mit Blick zur Tischmitte ausgerichtet -- so ist
nie gleichzeitig eine Kante vorne \emph{und} hinten in Reichweite, was
