...
Hardwareerfahrung noch nicht bewertet. Die Simulation modelliert weder
Bias noch Rauschen des Gyros; ob die in Abschnitt~\ref{lokalisierung}
beschriebene Komplementärfilter-Fusion damit auf der Zielhardware ebenso
funktioniert, muss dort geprüft werden.
...
Motoren. Falls nötig, müsste \texttt{ArduinoHAL::setLeftSpeed}/
\texttt{setRightSpeed} intern eine Regelschleife führen (Vorwärtsbefehl
setzen, Ist-Geschwindigkeit über Encoder und/oder Gyro schätzen,
Motoransteuerung nachführen), sodass die \texttt{RobotHAL}-Schnittstelle
für alle aufrufenden Komponenten unverändert bliebe. Die Regelung wäre
vollständig in der Hardwaretreiberebene gekapselt. Diese Regelschleife ist
