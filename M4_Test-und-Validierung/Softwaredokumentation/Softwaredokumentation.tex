...
Hochachse in rad/s) unverändert zu einer realen IMU passt, ist mangels
Hardwareerfahrung noch nicht abschließend bewertet, folgende Leitplanken
stehen aber inzwischen fest (Rückmeldung 16.09.2026).
...
Neu gegenüber der Simulation ist die \textbf{Kalibrierung}: Die Simulation
modelliert weder Bias noch Rauschen des Gyros, ein echter MEMS-Gyro hat
dagegen im Stillstand einen Rest-Offset ungleich null. Üblich ist eine
kurze Startkalibrierung (Roboter für ein bis zwei Sekunden stillhalten,
Rohwert mitteln, diesen Bias von jeder folgenden Messung abziehen). Für den
