...
\endfoot
Projekt & Coasterbot\\
Referenz Testkonzept & \footnotesize\texttt{M3\_Produktentwicklung/Testkonzept/Testkonzept.tex}\\
...
\begin{longtable}[]{@{}
  p{0.09\linewidth}p{0.23\linewidth}p{0.04\linewidth}p{0.08\linewidth}p{0.13\linewidth}p{0.38\linewidth}@{}}
...
\begin{longtable}[]{@{}
  p{0.12\linewidth}p{0.23\linewidth}p{0.04\linewidth}p{0.08\linewidth}p{0.13\linewidth}p{0.35\linewidth}@{}}
...
\begin{longtable}[]{@{}
  p{0.09\linewidth}p{0.23\linewidth}p{0.04\linewidth}p{0.08\linewidth}p{0.13\linewidth}p{0.39\linewidth}@{}}
...
\tightlist
\item
  Bislang wurden nur die Simulationstests durchgeführt, die
...
\item
  ...
  benötigen isolierte Testharnesses für die einzelnen Softwaremodule, welche
  noch nicht aufgesetzt wurden.
\item
...
\item
  ...
  Simulationsumfangs (kein Untersetzerhandling in der Simulation implementiert) und bleibt
