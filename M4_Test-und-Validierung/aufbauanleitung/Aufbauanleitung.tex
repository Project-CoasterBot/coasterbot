...
2 & 18.09.2026 & Such & Gehäusemontage ergänzt \\
\bottomrule
\end{tabular}
\clearpage
...
Die Software wird in der Build-Umgebung mit den folgenden Befehlen der PlatformIO Softwareumgebung kompiliert und an den Microcontroller übertragen. 
...
\includegraphics[scale=0.05]{montage_gereon/gesamt_montage/PXL_20260912_200946614.jpg}
\includegraphics[scale=0.05]{montage_gereon/gesamt_montage/PXL_20260912_201010425.jpg}
...
Nun wird die Rückenplatte in das Chassis eingesetzt und das Chassis mit der Abdeckplatte geschlossen und fixiert. 

\includegraphics[scale=0.06]{montage_gereon/abschluss/PXL_20260918_082828534.jpg}
\includegraphics[scale=0.06]{montage_gereon/abschluss/PXL_20260918_082843487.jpg}



\subsection{Montage der Räder}

Anschließend werden die vier Räder auf die Motoren vorsichtig aufgesteckt. 

\begin{warnbox}
Vorsicht, der laterale Druck auf das Chassis darf nicht zu hoch sein, da sonst die Seitenwand aus den Stützen brechen können. 
\end{warnbox}

\includegraphics[scale=0.08]{montage_gereon/abschluss/PXL_20260918_082942570.jpg}
...
Beim fertigen Ergebnis sollte darauf geachtet werden, dass der Unterboden nicht schleift sowie der Abstand des Unterbodens bis zur Tischkante kleiner gleich 1.5cm beträgt, andernfalls können die Coaster nicht korrekt aufgenommen werden. 

\includegraphics[scale=0.08]{montage_gereon/abschluss/PXL_20260918_082957663.jpg}
\includegraphics[scale=0.08]{montage_gereon/abschluss/PXL_20260918_083006873.jpg}


\includegraphics[scale=0.08]{montage_gereon/abschluss/PXL_20260918_090534564.jpg}
